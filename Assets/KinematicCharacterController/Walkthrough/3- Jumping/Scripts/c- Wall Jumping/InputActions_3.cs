...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/3- Jumping/Scripts/c- Wall Jumping/InputActions_3.inputactions
//
...
public partial class @InputActions_3: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_3()
    {
    ...
    {
        private @InputActions_3 m_Wrapper;
        public PlayerActions(@InputActions_3 wrapper) { m_Wrapper = wrapper; }
