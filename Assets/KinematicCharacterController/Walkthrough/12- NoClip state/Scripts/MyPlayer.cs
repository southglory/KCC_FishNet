...
namespace KinematicCharacterController.Walkthrough.NoClipState
{
    public class MyPlayer : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (isNewInputSystem)
            {
                localInput = GetComponentInChildren<MyPlayerInputHandler12>();
        ...
        private void HandleCharacterNewInput()
        {
            ...
            characterInputs.NoClipDown = localInput.skill_1; localInput.skill_1 = false;
            characterInputs.JumpHeld = localInput.jumpHeld;
            characterInputs.CrouchHeld = localInput.crouchHeld;
