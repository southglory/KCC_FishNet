...
public partial class MyPlayerInputHandler12 : MonoBehaviour
{

    // Store our controls
    InputActions_12 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_12();
...
partial class MyPlayerInputHandler12
{
    ...
    {
        if (ctx.started) { jumping = true; jumpHeld = true; }
    ...
    {
        if (ctx.started) { crouchingDown = true; crouchHeld = true; }
        if (ctx.canceled) { crouchingDown = false; crouchHeld = false; }
    }
