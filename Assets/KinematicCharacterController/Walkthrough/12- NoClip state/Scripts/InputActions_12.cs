...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/12- NoClip state/Scripts/InputActions_12.inputactions
//
...
public partial class @InputActions_12: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_12()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_12"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputActions_12 m_Wrapper;
        public PlayerActions(@InputActions_12 wrapper) { m_Wrapper = wrapper; }
