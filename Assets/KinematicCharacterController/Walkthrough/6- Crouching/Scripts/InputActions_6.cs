...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/6- Crouching/Scripts/InputActions_6.inputactions
//
...
public partial class @InputActions_6: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_6()
    {
    ...
    {
        private @InputActions_6 m_Wrapper;
        public PlayerActions(@InputActions_6 wrapper) { m_Wrapper = wrapper; }
