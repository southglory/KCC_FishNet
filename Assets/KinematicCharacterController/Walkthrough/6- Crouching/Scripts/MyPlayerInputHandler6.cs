...
public partial class MyPlayerInputHandler6 : MonoBehaviour
{

    // Store our controls
    InputActions_6 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_6();
...
partial class MyPlayerInputHandler6
{
