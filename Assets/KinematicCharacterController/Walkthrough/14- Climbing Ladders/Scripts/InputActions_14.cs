...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/14- Climbing Ladders/Scripts/InputActions_14.inputactions
//
...
public partial class @InputActions_14: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_14()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_14"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputActions_14 m_Wrapper;
        public PlayerActions(@InputActions_14 wrapper) { m_Wrapper = wrapper; }
