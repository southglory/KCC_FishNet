...
public partial class MyPlayerInputHandler14
    : MonoBehaviour
{

    // Store our controls
    InputActions_14 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_14();
...
partial class MyPlayerInputHandler14
{
