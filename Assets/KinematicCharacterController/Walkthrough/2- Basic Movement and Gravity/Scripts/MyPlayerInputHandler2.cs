...
public partial class MyPlayerInputHandler2 : MonoBehaviour
{

    // Store our controls
    InputActions_2 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_2();
...
partial class MyPlayerInputHandler2
{
