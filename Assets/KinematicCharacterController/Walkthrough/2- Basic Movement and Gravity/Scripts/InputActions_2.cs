...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/2- Basic Movement and Gravity/Scripts/InputActions_2.inputactions
//
...
public partial class @InputActions_2: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_2()
    {
    ...
    {
        private @InputActions_2 m_Wrapper;
        public PlayerActions(@InputActions_2 wrapper) { m_Wrapper = wrapper; }
