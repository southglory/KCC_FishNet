...
public partial class MyPlayerInputHandler4 : MonoBehaviour
{

    // Store our controls
    InputActions_4 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_4();
...
partial class MyPlayerInputHandler4
{
