...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/4- Landing and leaving ground/Scripts/InputActions_4.inputactions
//
...
public partial class @InputActions_4: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_4()
    {
    ...
    {
        private @InputActions_4 m_Wrapper;
        public PlayerActions(@InputActions_4 wrapper) { m_Wrapper = wrapper; }
