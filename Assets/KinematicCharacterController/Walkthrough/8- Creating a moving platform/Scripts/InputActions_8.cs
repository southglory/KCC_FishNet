...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/8- Creating a moving platform/Scripts/InputActions_8.inputactions
//
...
public partial class @InputActions_8: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_8()
    {
    ...
    {
        private @InputActions_8 m_Wrapper;
        public PlayerActions(@InputActions_8 wrapper) { m_Wrapper = wrapper; }
