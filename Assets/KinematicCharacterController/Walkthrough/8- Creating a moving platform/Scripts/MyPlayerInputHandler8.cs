...
public partial class MyPlayerInputHandler8 : MonoBehaviour
{

    // Store our controls
    InputActions_8 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_8();
...
partial class MyPlayerInputHandler8
{
