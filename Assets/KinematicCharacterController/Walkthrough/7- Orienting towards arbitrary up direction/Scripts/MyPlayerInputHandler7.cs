...
public partial class MyPlayerInputHandler7 : MonoBehaviour
{

    // Store our controls
    InputActions_7 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_7();
...
partial class MyPlayerInputHandler7
{
