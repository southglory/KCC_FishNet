...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/10- Multiple movement states setup/Scripts/InputActions_10.inputactions
//
...
public partial class @InputActions_10: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_10()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_10"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputActions_10 m_Wrapper;
        public PlayerActions(@InputActions_10 wrapper) { m_Wrapper = wrapper; }
