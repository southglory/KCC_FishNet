...
public partial class MyPlayerInputHandler10 : MonoBehaviour
{

    // Store our controls
    InputActions_10 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_10();
...
partial class MyPlayerInputHandler10
{
