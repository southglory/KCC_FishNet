...
public partial class MyPlayerInputHandler11 : MonoBehaviour
{

    // Store our controls
    InputActions_11 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_11();
    ...
    private void Subscribe_Input()
    {
        ...
        skill_1_Action.performed += GetForcedInput;
...
partial class MyPlayerInputHandler11
{
