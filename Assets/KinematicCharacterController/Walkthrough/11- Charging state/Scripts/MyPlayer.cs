...
namespace KinematicCharacterController.Walkthrough.ChargingState
{
    public class MyPlayer : MonoBehaviour
    {
        ...
        private MyPlayerInputHandler11 localInput;
        ...
        private void Start()
        {
            ...
            if (isNewInputSystem)
            {
                localInput= GetComponentInChildren<MyPlayerInputHandler11>();
        ...
        private void HandleCharacterNewInput()
        {
            ...
            characterInputs.ChargingDown = localInput.skill_1; localInput.skill_1 = false;
