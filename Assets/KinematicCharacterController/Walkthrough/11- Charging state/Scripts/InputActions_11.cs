...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/11- Charging state/Scripts/InputActions_11.inputactions
//
...
public partial class @InputActions_11: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_11()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_11"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputActions_11 m_Wrapper;
        public PlayerActions(@InputActions_11 wrapper) { m_Wrapper = wrapper; }
