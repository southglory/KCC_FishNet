...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/5- Adding velocities and impulses/Scripts/InputActions_5.inputactions
//
...
public partial class @InputActions_5: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_5()
    {
    ...
    {
        private @InputActions_5 m_Wrapper;
        public PlayerActions(@InputActions_5 wrapper) { m_Wrapper = wrapper; }
