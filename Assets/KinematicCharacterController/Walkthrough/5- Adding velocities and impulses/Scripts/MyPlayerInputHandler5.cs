...
public partial class MyPlayerInputHandler5 : MonoBehaviour
{

    // Store our controls
    InputActions_5 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_5();
...
partial class MyPlayerInputHandler5
{
