...
public partial class MyPlayerInputHandler15
    : MonoBehaviour
{

    // Store our controls
    InputActions_15 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_15();
...
partial class MyPlayerInputHandler15
{
