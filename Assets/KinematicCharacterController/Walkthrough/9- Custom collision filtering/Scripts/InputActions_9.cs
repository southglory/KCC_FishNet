...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/9- Custom collision filtering/Scripts/InputActions_9.inputactions
//
...
public partial class @InputActions_9: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_9()
    {
    ...
    {
        private @InputActions_9 m_Wrapper;
        public PlayerActions(@InputActions_9 wrapper) { m_Wrapper = wrapper; }
