...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/13- Swimming state/Scripts/InputActions_13.inputactions
//
...
public partial class @InputActions_13: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_13()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_13"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputActions_13 m_Wrapper;
        public PlayerActions(@InputActions_13 wrapper) { m_Wrapper = wrapper; }
