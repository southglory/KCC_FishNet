...
public partial class MyPlayerInputHandler13
    : MonoBehaviour
{

    // Store our controls
    InputActions_13 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_13();
...
partial class MyPlayerInputHandler13
{
