...
//     version 1.5.1
//     from Assets/KinematicCharacterController/Walkthrough/16- FramePerfect Rotation/Scripts/InputActions_16.inputactions
//
...
public partial class @InputActions_16: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_16()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_16"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputActions_16 m_Wrapper;
        public PlayerActions(@InputActions_16 wrapper) { m_Wrapper = wrapper; }
