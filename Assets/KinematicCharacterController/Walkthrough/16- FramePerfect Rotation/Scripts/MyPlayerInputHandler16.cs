...
public partial class MyPlayerInputHandler16
    : MonoBehaviour
{

    // Store our controls
    InputActions_16 primaryInputActions;
    ...
    private void Awake()
    {
        primaryInputActions = new InputActions_16();
...
partial class MyPlayerInputHandler16
{
