...
//     version 1.5.1
//     from Assets/KinematicCharacterController/ExampleCharacter/Scripts/InputActions_17.inputactions
//
...
public partial class @InputActions_17: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_17()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_17"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    {
        private @InputActions_17 m_Wrapper;
        public PlayerActions(@InputActions_17 wrapper) { m_Wrapper = wrapper; }
